...
const UserHeader = () => {
  ...
  // Check if the current path includes "UserArazForm"
  const isUserArazForm = location.pathname.includes('UserArazForm');
        ...
        <div className="row align-items-center">
          ...
          <div className="col-8 col-sm-9">
            <div className="header-left-div d-flex align-items-center justify-content-end gap-2 gap-sm-2 gap-md-4">
              {isLoggedIn && !isUserArazForm && (
                <div className="new-araz-div">
                  <button
                    onClick={() => navigate('/user/UserArazForm')}
                    className="btn btn-primary2 btn-araz-start"
                  >
                    Start a new Araz
                    <RightArrowIcon />
                  </button>
