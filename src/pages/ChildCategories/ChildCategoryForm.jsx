...
const ChildCategoryForm = ({ initialData, handleSubmit, subCategories }) => {
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      handleSubmit(params);
      resetForm();
      var myOffcanvas = document.getElementById('add_child_category');
  ...
  return (
    <div
      ...
      tabIndex="-1"
      id="add_child_category"
      aria-labelledby="offcanvasRightLabel"
    >
      <div className="offcanvas-header">
        <h5 id="offcanvasRightLabel">
          {initialData
            ? `Child Category ID: ${initialData.id}`
