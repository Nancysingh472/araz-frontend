    ...
    <div className="notification-content px-20">
      ...
      >
        <div className="offcanvas-header">
          <h5 id="offcanvasRightLabel">Manage this user</h5>
          ...
          <form>
            <div className="canvas-group mb-4">
              ...
              <input
                ...
                type="text"
                value="Mohammed Sabuwala"
              />
            </div>
            <div className="canvas-group mb-4">
              <label>Assign a role to this user</label>
                        ...
                        <td>
                          <div className="action-btn-list">
                            <button
                              className="btn p-0"
                              data-bs-toggle="offcanvas"
                              data-bs-target="#Manage_This_User"
                              aria-controls="offcanvasRight"
                            >
                              <svg
                                width="26"
