...
const BusinessTypeForm = ({ initialData, handleSubmit }) => {
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      handleSubmit(params);
      resetForm();
      var myOffcanvas = document.getElementById('add_business_type');
    ...
    >
      <div className="offcanvas-header">
        <h5 id="offcanvasRightLabel">
          {initialData
            ? `Business Type ID: ${initialData.id}`
      ...
      <div className="offcanvas-body">
        <form onSubmit={formik.handleSubmit}>
          <div className="canvas-group mb-4">
            <label>Name of the Business Type</label>
            <input
