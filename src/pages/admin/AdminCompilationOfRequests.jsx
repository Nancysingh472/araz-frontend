...
const AdminCompilationOfRequests = () => {
  return (
              ...
              <div className="col-sm-6">
                <div className="rph-right">
                  <div className="rph-group circle-icon-btn gap-3 d-flex justify-content-end align-items-center flex-wrap">
                    <button className="btn btn-disable text-dark shadow-none w-auto">
                      Print files
                    </button>
                    <button className="btn btn-primary shadow-none w-auto">
                      Print files
                    </button>
                  </div>
                </div>
          ...
          <div className="raza-progress-body">
            <div className="row">
              ...
              <div className="col-md-6 col-lg-5">
                <div className="generate-card raza-progress-card h-100">
                  <p className="text-center mb-3">
                    Generate Istershaad & Manzoori Documents
                  </p>
                  <div className="raza-progress-body text-center py-4">
                    <button
                    ...
                    <div className="generate-table table-responsive">
                      <table className="table custom-table" width="100%">
                        ...
                        <tbody>
                          <tr>
                            <td className="text-start">00128</td>
                            <td className="text-start">Mohammedi Hardware</td>
...
export default AdminCompilationOfRequests;
